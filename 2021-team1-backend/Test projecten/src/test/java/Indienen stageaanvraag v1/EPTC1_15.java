...
public class EPTC1_15 {
    ...
    public void UCT1punt1() throws InterruptedException {
        ...
        driver.findElement(By.id("companyCity")).sendKeys("DYAHrbEEzeeSVSLTIMgNTcdeWGDwJDtfTfxtZFwzoUhSHhXYWErWRoZSAxREmeTnafuekztOquGgPxbBAeBKUyVdZDTMMkpGbscB\n");
